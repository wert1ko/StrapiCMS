...
export interface ApiAboutSpeakerAboutSpeaker
  extends Struct.CollectionTypeSchema {
  collectionName: 'about_speakers';
  info: {
    displayName: 'AboutSpeaker';
    pluralName: 'about-speakers';
    singularName: 'about-speaker';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-speaker.about-speaker'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    speakerImg: Schema.Attribute.Media<
...
export interface ApiHomeScreeenHomeScreeen extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'HomeScreeen';
    pluralName: 'home-screeens';
    singularName: 'home-screeen';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSecondScreenSecondScreen
  extends Struct.CollectionTypeSchema {
  collectionName: 'second_screens';
  info: {
    displayName: 'SecondScreen';
    pluralName: 'second-screens';
    singularName: 'second-screen';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    firstBlock: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::second-screen.second-screen'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    secondBlock: Schema.Attribute.String;
    thirdBlock: Schema.Attribute.String;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiThirdScreenThirdScreen extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'third-screens';
    singularName: 'third-screen';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fifthBlock: Schema.Attribute.String;
    firstBlock: Schema.Attribute.String;
    fourthBlock: Schema.Attribute.String;
    isButton: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::third-screen.third-screen'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    secondBlock: Schema.Attribute.String;
    sixthBlock: Schema.Attribute.String;
    thirdBlock: Schema.Attribute.String;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
